<x-app-layout>
    ...
    <div id="categories" class="flex-1 flex flex-col lg:ml-64 overflow-hidden px-10 mt-10">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden mt-2">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gradient-to-r from-blue-600 to-blue-700 text-center">
                        <tr>
                            <th class="px-6 py-4 text-xs font-semibold text-white uppercase tracking-wider">#</th>
                            <th class="px-6 py-4 text-xs font-semibold text-white uppercase tracking-wider">Category Name</th>
                            <th class="px-6 py-4 text-xs font-semibold text-white uppercase tracking-wider">Description</th>
                            <th class="px-6 py-4 text-xs font-semibold text-white uppercase tracking-wider">Actions</th>
                        </tr>
                    </thead>
