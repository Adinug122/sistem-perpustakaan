<x-app-layout>
    ...
    <div id="categories" class="flex-1 flex flex-col lg:ml-64 overflow-hidden px-10 mt-10">
        <h2 class="text-3xl font-bold text-gray-800 mb-6">Manage Peminjaman</h2>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gradient-to-r from-blue-600 to-blue-700">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Judul Buku</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Peminjam</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Tanggal Pinjam</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Tanggal Kembali</th>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center items-center gap-2">
                                        ...
                                        <a href="{{ route('admin.pinjam.edit', $item->id) }}"
